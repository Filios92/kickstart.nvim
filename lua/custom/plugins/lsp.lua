    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          if vim.bo[event.buf].filetype == 'codecompanion' then return end
          ...
          map('<leader>cr', vim.lsp.buf.rename, 'Rename under cursor')
          ...
          map('grd', picker.lsp_definitions, '[G]oto [D]efinition') --  To jump back, press <C-t>.
          ...
          if picker == Snacks.picker then
            ...
            map('<leader>ss', picker.lsp_symbols, 'LSP Symbols')
            map('<leader>sS', picker.lsp_workspace_symbols, 'LSP Workspace Symbols')
          else
            ...
            map('<leader>ss', picker.lsp_document_symbols, 'LSP Symbols')
